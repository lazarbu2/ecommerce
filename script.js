...
function fixSite() {
  if (site.classList.contains("showmenu")) {
    site.classList.add("sitefixed");
  } else {
    site.classList.remove("sitefixed");
  }
}
site.addEventListener("click", fixSite);
...
//auto close by click outside of filter
